...
const ImageProduct = (props) => {
    return (
        <img
            src={props.src}
            className={`${(props.primary) ? 'xl:h-[450px] h-[340px] w-full' : 'xl:h-24 xl:w-48 h-20 w-40 hover:border-2 hover:scale-105 transition-transform hover:border-red-500'} cursor-pointer mb-6  object-cover rounded-lg`} />)
}
...
export default function Product() {
    ...
    return (
        <div>
            ...
            <div className='mt-5 flex xl:space-x-10 pb-32'>
                <div className='w-8/12'>
                    ...
                    <p className='mt-5 text-gray-600  leading-8'>The Nike Air Max 720 SE goes bigger than ever before with Nike's tallest Air unit yet for unimaginable, all-day comfort. There's super breathable fabrics on the upper, while colours add a modern edge.<br /><br />
